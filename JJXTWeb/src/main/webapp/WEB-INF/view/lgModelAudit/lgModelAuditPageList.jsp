	...
	<div class="tableBody">
		<div class="panel panel-default" style="margin-bottom: 0px;">
			<div class="panel-body form-group" style="margin-bottom: 0px;">
				...
				<div class="col-sm-2">
					<select id="search_auditFlag"  class="form-control" name="auditFlag" placeholder="模板类型">
						<option value="">---模板类型---</option>
						<option value="black">黑模板</option>
						<option value="white">白模板</option>
					</select>
				</div>
				<div class="col-sm-2">
				...
				<div class="ibox-content">
					<form id="addForm" method="post" class="form-horizontal">
						<div class="form-group">
							<label class="col-sm-2 control-label">审核模板</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" name="content"
									id="content" />
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<select id="auditFlag"  class="form-control" name="auditFlag">
				...
				<div class="ibox-content">
					<form id="editForm" method="post" class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select id="editAuditFlag"  class="form-control" name="auditFlag">
									<option value="">---请选择---</option>
									<option value="black">黑模板</option>
									<option value="white">白模板</option>
								</select>
...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/lgModelAudit/lgModelAuditPageList.js"></script>
</html>