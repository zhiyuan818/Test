...
<body>
	<div class="tableBody">
		...
		<div class="panel-body form-group" style="margin-bottom:0px;">
			<div class="col-sm-2">
				<select name="companyName" id="companyName"
						...
						<c:forEach var="name" items="${complainNames}" >
		...
		<table id="appcomplaintab" class="table table-hover"></table>
	</div>

</body>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/complain/appComplain.js"></script>
</html>