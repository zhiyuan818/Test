$(function() {
	...
	$('#mytab').bootstrapTable({
		...
		url : "findLogList.action",// 请求后台url
...
function queryParams(params) {
	return {
		...
		userName : $("#userName").val(),// 账户名称
		operation : $("#operation").val(),// 操作类型
		newData : $("#newData").val(),// 更新后的数据
		oldData : $("#oldData").val(),// 更新前的数据
		bussiness : $("#bussiness").val(),// 业务类型
