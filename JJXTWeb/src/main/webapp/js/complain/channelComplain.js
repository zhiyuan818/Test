$(function() {
	...
	$(window).resize(function() {
		$('#chacomplaintab').bootstrapTable('resetView', {
			height : tableHeight()
		})
	})
	$('#chacomplaintab').bootstrapTable({
		method : 'post',
		contentType : "application/x-www-form-urlencoded",
		url : "findAllLists.action",
		height : tableHeight(),
	...
	$("#search_btn").click(function() {
			...
			$('#chacomplaintab').bootstrapTable('refreshOptions', {
				pageNumber : 1,
				url : "findListByChannelId.action"
				});
	});
